 ...
 *  he got bored of it and decided to update value of its element. In one second he can 
 *  increase value of each array element by 1. He wants each array element's value to
 *   become greater than or equal to K. Please help Micro to find out the minimum amount 
 *   of time it will take, for him to do so.
